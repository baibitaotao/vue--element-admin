      ...
      <b-col cols="4">
        <!-- <b-navbar v-b-scrollspy:scrollspy-nested class="flex-column">
          ...
          <b-nav pills class="flex-column">
            <b-nav-item :to="{ hash: '#item-1' }">Item 1</b-nav-item>
            <b-nav pills class="flex-column">
              <b-nav-item class="ml-3 my-1" :to="{ hash: '#item-1-1' }" >Item 1-1</b-nav-item>
              <b-nav-item class="ml-3 my-1" :to="{ hash: '#item-1-2' }" >Item 1-2</b-nav-item>
            </b-nav>
            <b-nav-item href="#item-2">Item 2</b-nav-item>
            <b-nav-item href="#item-3">Item 3</b-nav-item>
            <b-nav pills class="flex-column">
              <b-nav-item class="ml-3 my-1" :to="{ hash: '#item-3-1' }" >Item 3-1</b-nav-item>
              <b-nav-item class="ml-3 my-1" :to="{ hash: '#item-3-2' }" >Item 3-2</b-nav-item>
            </b-nav>
          </b-nav>
        </b-navbar> -->
