<template>
    ...
    <div style="width:410px">
     ...
     <div class="xinjianOrshanchu">
       <el-button size="mini" @click = 'isShowNewBaner = true'>新建</el-button>
       <el-button size="mini">删除</el-button>
     </div> 
     <my-table></my-table>   
     <transition name="el-zoom-in-center">   
     <tanKuang v-show="isShowNewBaner" :isShowNewBaner = 'isShowNewBaner' @modifyBannerStatus = "modifyBannerStatus"></tanKuang>
     </transition> 
    </div>
</template>
